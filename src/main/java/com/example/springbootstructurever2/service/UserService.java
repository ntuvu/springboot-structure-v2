...
public interface UserService {
    ...
    PageResponse<?> getAllUsersWithSortByColumnsAndSearch(int pageNo, int pageSize, String search, String sort);

    PageResponse<?> getUsersWithCriteria(int pageNo, int pageSize, String sort, String address, String... search);
}
